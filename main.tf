...
resource "azurerm_container_group" "example" {
  ...
  dns_name_label      = "library-marto"
  os_type             = "Linux"

  container {
    name   = "web-app"
    image  = "martingradev/library" # Replace with your ACR registry and image name
    cpu    = "1"
    memory = "1.5"
